...
export default function PresentationContainer() {
  return (
    <section className="w-full md:min-h-[calc(100vh_-_80px)] grid grid-flow-row md:grid-flow-col md:grid-cols-2 md:gap-12 lg:gap-24 py-24">
      <div className="flex order-2 md:order-none flex-col items-center justify-center text-start px-4 lg:p-24 gap-8">
        ...
        <div className="w-full flex gap-4 ">
          <Link href={'#explore-my-work'} className="whitespace-nowrap w-full md:w-fit flex items-center justify-center border-2 duration-150 border-background-dark bg-background-dark hover:bg-transparent hover:text-background-dark text-background-light px-8 py-3">
