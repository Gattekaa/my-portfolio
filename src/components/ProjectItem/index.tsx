  ...
  return (
    <div className="w-full min-h-[500px] flex flex-col gap-4">
      <Element href={href} target="_blank" className="w-full h-[416px] relative">
        <Image src={photo} fill className={`${alterPhoto ? 'hover:opacity-0' : '!static'} aspect-video duration-300 z-[10] !h-[416px] !min-h-[416px] object-cover`} alt="Project image" />
        {
          alterPhoto ? <>
            ...
            <Image src={alterPhoto} fill className={`!static aspect-video !h-[416px] !min-h-[416px] object-cover`} alt="Project image" />
          </>
